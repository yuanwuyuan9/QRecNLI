...
from coverage_metrics import CoverageAndNoveltyEvaluator
...
if __name__ == "__main__":
    USER_JSON_DIR = "./dataset/spider/user-json-test"
    # This needs to be configured to specify the database for analysis. Here,
    # my user test query records are all generated based on "customers_and_addresses".
    DEFAULT_SCHEMA_FOLDER = "customers_and_addresses"
    SCHEMA_BASE_DIR = "./dataset/spider/database"
